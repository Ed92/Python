...
def start():
    ...
    sleep(1)
    do_what = input("Just as you started to hope, you heard an intense ROAR! You see a Bear swiftly moving towards you. You only have time to react. What do you do?(left/south/right/north")
...
def dodge():
    print("You keep running towards the mysterious light, but you dont seem to be getting any closer. Your legs are tired and you")
introduction()
start()
